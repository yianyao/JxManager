...
$(function (){
    ...
    var _table = table.dataTable({
        ...
        "columns":[
            ...
            {
                "createdCell":function(td,cellData,rowData,row,col){
                    var access = '<a href = "access/group_id/' + rowData.id + '/group_name/' + rowData.title + '">访问授权\<\/a\>&nbsp;&nbsp;';
                    var cate =  '<a href = "category/group_id/' + rowData.id + '/group_name/' + rowData.title + '">分类授权\<\/a\>&nbsp;&nbsp;';
                    var user = '<a href = "user">成员授权\<\/a\>';
                    $(td).html(access).append(cate).append(user);
                },
                data:null,
                orderable:false,
                searchable:false
            ...
            {
                "createdCell":function(td,cellData,rowData,row,col){
                    var ahref = '<a href = "editGroup/id/' + rowData.id + '" ';
        ...
        "initComplete":function(settings,response){
            ...
            $("div.toolbar").html('<a href="addGroup"  class="btn green"><i class="fa fa-plus "></i>添加新纪录</a>&nbsp;' +
    ...
    deleteRow : function(selectedItems) {
        ...
        if (selectedItems&&selectedItems.length) {
            ...
            layer.confirm(message, function(){
                $.ajax({
                    url:"deleteGroup",
                    data:{Auth_group:selectedItems.toString()},
                    type:"post",
