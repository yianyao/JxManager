var Demo = function () {
    var e = function () {
        ...
        $(".theme-colors > li", e).click(function () {
            ...
            d(a), $("ul > li", e).removeClass("active"), $(this).addClass("active"), "dark" === a ? $(".page-actions .btn").removeClass("red-haze").addClass("btn-default btn-transparent") : $(".page-actions .btn").removeClass("btn-default btn-transparent").addClass("red-haze")
